package creational.abstractfactory.reflection;
...
class HotDrinkMachine {
	...
	public HotDrinkMachine() throws Exception {
		...
		for (AvailableDrink drink : AvailableDrink.values()) {
			...
			Class<?> factory = Class.forName("creational.abstractfactory.reflection." + factoryName + "Factory");
		...
		Set<Class<? extends IHotDrinkFactory>> types = new Reflections("creational.abstractfactory.reflection") // ""
...
class AbstractFactoryDemoReflection {
